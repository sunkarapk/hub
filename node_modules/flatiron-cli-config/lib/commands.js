...
exports.usage = [
  '`<app> conf *` commands allow you to edit your',
...
//
// Usage for `<app> conf set <key> <value>`
//
exports.set.usage = [
...
exports.delete = function (key, callback) {
  ...
  if (!value) {
    ...
    cliConfig.app.log.help('Use ' + (cliConfig.app.name || '<app>') + ' conf set <key> <value>');
    return callback();
  }
...
exports.list = function (callback) {
  ...
  cliConfig.app.inspect.putObject(data, {
    ...
    auth: function (line) {
      var auth = line.match(/token.*\:\s(.*)\s},$/)[1];
...
//
// Usage for `<app> conf list`
//
exports.list.usage = [
  'Lists all configuration values currently',
  'set in the .hubconfig file',
  '',
  '<app> conf list'
];
